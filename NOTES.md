...
- **Auto-torch — DONE as opt-in (2026-06-26, see §9).** Still want the paired **"leash / stuck-while-following" detector** (re-path or surface when a follow stalls, e.g. against a sealed/anti-grief spot). Not yet built.
