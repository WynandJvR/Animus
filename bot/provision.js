...
function setDebugSink (fn) { dbgSink = fn; worldMemory.setDebugSink(fn); provCore.setDebugSink(fn); provHut.setDebugSink(fn); provFarm.setDebugSink(fn); provMining.setDebugSink(fn) } // forward: world-memory + core log through the same sink
